...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.progroup'
        db.add_column(u'ftodo_task', 'progroup',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.progroup'
        db.delete_column(u'ftodo_task', 'progroup')
    ...
    models = {
        ...
        u'ftodo.note': {
            'Meta': {'ordering': "['-date_modified']", 'object_name': 'Note'},
        ...
        u'ftodo.task': {
            'Meta': {'ordering': "['-has_due', 'date_due']", 'object_name': 'Task'},
            'bookmark': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'goal': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_due': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ftodo.Task']", 'null': 'True', 'blank': 'True'}),
            'progroup': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
