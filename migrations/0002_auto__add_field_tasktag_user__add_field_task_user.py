...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskTag.user'
        db.add_column(u'ftodo_tasktag', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Task.user'
        db.add_column(u'ftodo_task', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskTag.user'
        db.delete_column(u'ftodo_tasktag', 'user_id')

        # Deleting field 'Task.user'
        db.delete_column(u'ftodo_task', 'user_id')
